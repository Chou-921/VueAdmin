...
Mock.mock('http://localhost:8081/captcha', 'get', () => {
...
Mock.mock('http://localhost:8081/sys/userInfo','get',()=>{
    Result.data = {
        id: ' 1',
        username: 'User1',
...
Mock.mock('http://localhost:8081/logout','post',()=>{
    return Result
})
Mock.mock('http://localhost:8081/sys/menu/nav','get',()=>{
   ...
   let authoritys=['sysUser', "sysUser:save", "sys:user:delete"]
    Result.data={
       nav:nav,
...
Mock.mock('http://localhost:8081/sys/menu/list', 'get', () => {
    let menus = [
        {
            "id": 1,
...
Mock.mock(RegExp('http://localhost:8081/sys/menu/info/*'), 'get', () => {
...
Mock.mock(RegExp('http://localhost:8081/sys/menu/*'), 'post', () => {

    return Result
})
Mock.mock(RegExp('http://localhost:8081/sys/role/list*'), 'get', () => {
...
Mock.mock(RegExp('http://localhost:8081/sys/role/info/*'), 'get', () => {
...
Mock.mock(RegExp('http://localhost:8081/sys/user/list*'), 'get', () => {
    Result.data = {
        "records": [
            {
                "id": 1,
...
Mock.mock(RegExp('http://localhost:8081/sys/user/*'), 'post', () => {
    return Result
})

Mock.mock(RegExp('http://localhost:8081/sys/user/info/*'), 'get', () => {
